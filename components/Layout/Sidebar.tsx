...
function Sidebar() {
  ...
  return (
    <div
      className="bg-white h-[100vh] shadow-md  fixed top-[10vh] text-[#508479] font-semibold"
      ...
      >
        ...
        <Link href="/invite">
          ...
          >
            ...
            <div
              className={` ${
                value ? "hidden min-w-[130px] bg-black" : "z-50 min-w-[130px]"
              } ${invite ? "text-black" : ""}`}
            >
              <h1>Invite & Get $100</h1>
            </div>
            <div className={` ${value ? "hidden" : "pl-4 z-40"} `}>
